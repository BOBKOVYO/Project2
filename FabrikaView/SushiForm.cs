...
namespace BarView
{
    public partial class SushiForm : Form
    {
        ...
        private int? id;
        private readonly ISushi service;
            ...
            try
            {
                ...
                for (int i = 0; i < productElems.Count; ++i)
                {
                    productComponentBM.Add(new ElementRequirementsBindModel
                    {
                        ...
                        SushiID = productElems[i].SushiID,
                ...
                if (id.HasValue)
                {
                    service.UpdElement(new SushiBindModel
                    {
                        ID = id.Value,
                        SushiName = NameTextBox.Text,
                ...
                {
                    service.AddElement(new SushiBindModel
                    {
                        SushiName = NameTextBox.Text,
                        Price = Convert.ToInt32(PriceTextBox.Text),
                        ElementRequirements = productComponentBM
